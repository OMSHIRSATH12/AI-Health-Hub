...
with tab4:
    ...
    if articles:
        ...
        st.warning("No news articles found for your specific search. Please try a different term.")
    else:
        st.info("Showing general health news. Use the search bar above to find a specific topic.")